...
export function SubscriptionManagement() {
  ...
  const handleEditPlan = () => {
    // In a real application, this would make an API call to update the plan
          ...
          {selectedPlan && (
            <div className="grid gap-4 py-4">
              ...
              <div className="grid gap-2">
                ...
                <Input id="edit-description" defaultValue={selectedPlan.description} />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div className="grid gap-2">
              ...
              <div className="grid gap-2">
                ...
                <Select defaultValue={selectedPlan.interval}>
              ...
              <div className="flex items-center space-x-2">
                <Switch id="edit-active" defaultChecked={selectedPlan.isActive} />
