          ...
          {isEditing ? (
            <form onSubmit={handleSaveProfile} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-2">
                  {['Stocks', 'Bonds', 'ETFs', 'Crypto', 'Forex'].map(asset => (
                    <Badge 
                      key={asset}
            ...
            <div className="space-y-6">
                ...
                <div className="col-span-1 md:col-span-2 bg-muted/20 rounded-lg p-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-4">
                    ...
                    <div className="bg-white p-3 rounded-md shadow-sm">
                      ...
                      <p className={`text-2xl font-bold ${profileData.performanceYTD >= 0 ? 'investor-success' : 'investor-danger'}`}>
                ...
                <div>
                  ...
                  <div className="mt-2">
                    <Badge 
                      variant="outline" 
                      className={`
                        ${profileData.riskTolerance === 'conservative' ? 'investor-bg-info' : 
                          profileData.riskTolerance === 'moderate' ? 'investor-bg-success' : 
                          'investor-bg-warning'}
                      `}
                    >
                ...
                <div>
                  ...
                  <div className="mt-2">
                    <Badge 
                      variant="outline" 
                      className={`
                        ${profileData.tradingExperience === 'beginner' ? 'investor-bg-info' : 
                          profileData.tradingExperience === 'intermediate' ? 'investor-bg-success' : 
                          profileData.tradingExperience === 'advanced' ? 'investor-bg-warning' :
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
                ...
                <div>
                  ...
                  <p className={`mt-1 text-lg font-semibold ${profileData.performanceYTD >= 0 ? 'investor-success' : 'investor-danger'}`}>
