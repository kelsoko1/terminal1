    ...
    <Card className="p-6">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2">
          <Trophy className="h-5 w-5 investor-warning" />
      ...
      <div className="space-y-6">
        {challenges.map((challenge) => (
          <div key={challenge.id} className="space-y-3 pb-4 border-b last:border-0 last:pb-0">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  ...
                  <Badge variant={
                    ...
                    challenge.difficulty === 'Beginner' ? 'investor-bg-success investor-success' :
                    challenge.difficulty === 'Intermediate' ? 'investor-bg-warning investor-warning' : 
            ...
            <div className="flex items-center gap-2">
              <Award className="h-4 w-4 investor-warning" />
