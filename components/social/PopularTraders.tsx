        ...
        <div className="flex-1">
          ...
          <div className="grid grid-cols-2 gap-2 mt-3">
            <div>
              ...
              <div className={`font-semibold ${trader.stats.monthlyReturn >= 0 ? 'text-green-600' : 'text-red-600'}`}>
            ...
            <div>
              ...
              <div className="flex items-center">
                <AlertTriangle className={`h-4 w-4 mr-1 ${
                  trader.stats.riskScore <= 3 ? 'text-green-500' :
                  trader.stats.riskScore <= 6 ? 'text-yellow-500' : 'text-red-500'
                }`} />
            ...
            <div>
              ...
              <div className={`font-semibold ${trader.stats.totalReturn >= 0 ? 'text-green-600' : 'text-red-600'}`}>
