...
interface MarketUpdate {
  type: 'PRICE_UPDATE' | 'ORDER_UPDATE' | 'MARKET_INDEX_UPDATE' | 'NEWS_UPDATE' | 'SUBSCRIPTION_UPDATE';
  data: any;
}
...
class WebSocketService {
    ...
    try {
      ...
      switch (update.type) {
        ...
        case 'SUBSCRIPTION_UPDATE':
          this.handleSubscriptionUpdate(update.data);
          break;
      }
    } catch (error) {
  ...
  private handleSubscriptionUpdate(data: any) {
    // Handle subscription notifications through the notification service
    subscriptionNotificationService.handleSubscriptionNotification({
